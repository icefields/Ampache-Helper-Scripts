...
local function printHelp()
    print([[
Usage: lua albums.lua <server_url> <username> <password> [OPTIONS]
...
local res, code, response_headers, status, json_response, data = ampacheHttp.makeRequest(server_url, "albums", username, password, limit, filter_value, is_json_output)
